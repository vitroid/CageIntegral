...
def Avalue(T,mass):
    return -pc.NkB*T*(3./2.)*log(mass*0.001 / pc.NA * 2.0 * pi * pc.kB*T / pc.h**2)
...
def Cvalue(T,ixx,iyy,izz):
    ...
    return -pc.NkB*T*((1./2.)*log(ixx*iyy*izz) + (3./2.)*log(2.0 * pi * pc.kB*T / pc.h**2))
...
def test():
    ...
    for T in range(273,293):
        print (T,chempot(T,101326)+Avalue(T,16),chempot(T,antoine.VaporPressure(T, A,B,C)))
